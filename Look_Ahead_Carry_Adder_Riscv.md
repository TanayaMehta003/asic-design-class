...
Results when compared between the output from both GCC and RISC-V compiler, we observe the same output from both, which is expected.
...
**Note:** All the instructions have been generated by compiling in the RISC-V compiler using the 'OFast' flag.
